...
const {name, color, song, job, partner} = nestedMuppet
// 8. Use destructuring to assign songs 2 and 4, and Kermit's job and partner
const {song2, song4} = muppet.album.theMuppetMovie
const {nestedJob, nestedPartner} = nestedMuppet.nestedName.nestedPartner